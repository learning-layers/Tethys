package de.dbis.acis.cloud.i5cloud.client;
...
import de.dbis.acis.cloud.i5cloud.message.client.MessageAuth;
import de.dbis.acis.cloud.i5cloud.message.server.SMessageAuth;
import de.dbis.acis.cloud.i5cloud.util.GsonMessageBodyHandler;
